...
namespace alibaba\Api\alibaba\sms;
...
//    public $error;
    ...
    function __construct($config = array()) {
            $this->config = $config;
        // 配置参数
        $this->accessKeyId = $this->config ['accessKeyId'] ? $this->config ['accessKeyId'] : $this->accessKeyId;
        $this->accessKeySecret = $this->config ['accessKeySecret'] ? $this->config ['accessKeySecret'] : $this->accessKeySecret;
        $this->signName = $this->config ['signName'] ? $this->config ['signName'] : $this->signName;
        $this->templateCode = $this->config ['templateCode'] ? $this->config ['templateCode'] : $this->templateCode;
    }
     ...
     *
     */
    public function send_verify($mobile, $verify_code = array()) {
        $params = array (   //此处作了修改
...
//            'TemplateParam' => '{"code":"' . $verify_code . '"}'//更换为自己的实际模版
            'TemplateParam' => json_encode($verify_code)//更换为自己的实际模版
        );
        // 计算签名并把签名结果加入请求参数
